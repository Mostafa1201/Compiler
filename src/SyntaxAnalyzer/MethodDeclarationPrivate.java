...
public class MethodDeclarationPrivate implements MethodDeclaration {
	...
	public MethodDeclarationPrivate() {
	...
	public MethodDeclarationPrivate(String PrivatE, ArrayList<Type> type, ArrayList<String> comma,
	...
	public String getValue() {
		...
		return PrivatE+" "+typeidbeforeparan+leftParanthesis +typeid +commatypeid+rightParanthesis+leftCurly+vtemp+" "+sttemp+" "+Return+exp.getValue()+semicolon+rightCurly;
	}
