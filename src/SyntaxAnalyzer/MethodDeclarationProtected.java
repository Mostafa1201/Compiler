...
public class MethodDeclarationProtected implements MethodDeclaration {
	...
	public MethodDeclarationProtected() {
	...
	public MethodDeclarationProtected(String ProtecteD, ArrayList<Type> type, ArrayList<String> comma,
	...
	public String getValue() {
		...
		return ProtecteD+" "+typeidbeforeparan+leftParanthesis +typeid +commatypeid+rightParanthesis+leftCurly+vtemp+" "+sttemp+" "+Return+exp.getValue()+semicolon+rightCurly;
	}
